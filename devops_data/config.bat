...
set EnginePath=C:\Epic Games\UE Binary\UE_5.1
...
set ProjectPureName=UnrealChatGPT4
...
set COPYRIGHT_LINE=// All content created by ChatGPT4, Copyright LifeEXE. All Rights Reserved.
